        ...
        do {
            ...
            switch (choice) {
                ...
                case 2: // Chức năng sửa đổi dữ liệu nhân viên
                    System.out.print("Enter Employee ID to update: "); String upId = sc.nextLine();
                    Employee current = empMgr.findById(upId);
                    if (current == null) {
                        System.out.println("Error: Employee not found.");
                    } else {
                        System.out.print("New Name (Current: " + current.getEmployeeName() + "): "); String newName = sc.nextLine();
                        System.out.print("New Role (Current: " + current.getRole() + "): "); String newRole = sc.nextLine();
                        System.out.print("New Phone (Current: " + current.getPhoneNumber() + "): "); String newPhone = sc.nextLine();
                ...
                case 3: // Chức năng xóa bỏ nhân viên
                    System.out.print("Enter Employee ID to remove: "); String rmId = sc.nextLine();
                ...
                case 4: // Chức năng tìm kiếm theo từ khóa (ID hoặc Tên)
                    System.out.print("Enter Keyword (ID or Name) to search: "); String kw = sc.nextLine();
                ...
                case 5: // Chức năng hiển thị toàn bộ danh sách
                    empMgr.displayEmployees();
                    break;
