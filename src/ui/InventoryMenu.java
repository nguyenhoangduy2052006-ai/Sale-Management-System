            ...
            switch (choice) {
                ...
                case 2: // CHỨC NĂNG CẬP NHẬT
                    ...
                    if (current == null) {
                        ...
                        System.out.print("New Item Name (Current: " + current.getItemName() + "): ");
                        String newName = sc.nextLine();
                        System.out.print("New Quantity (Current: " + current.getQuantity() + "): ");
                ...
                case 4: // CHỨC NĂNG TÌM KIẾM
                    ...
                    if (searchRes.isEmpty()) {
                        ...
                        System.out.println("\n--- Search Results ---");
                        for (Inventory i : searchRes) {
                            System.out.println(i.toString()); // In các kết quả tìm thấy
                        }
                    }
                    break;
                case 5:
